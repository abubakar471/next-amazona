...
const Order = () => {
    ...
    const { shippingAddress, paymentMethod, isDelivered, deliveredAt,
        isPaid, paidAt, orderItems, itemsPrice, taxPrice, shippingPrice,
        totalPrice } = order;

    return (
        <Layout title={`Order ${orderId}`}>
            <h1 className='my-4 text-xl'>{`Order ${orderId}`}</h1>
                ...
                <div className='grid md:grid-cols-4 md:gap-5'>
                    <div className='overflow-x-auto md:col-span-3'>
                        ...
                        <div className='card p-5'>
                            ...
                            {isPaid ? (
                                <div className='alert-success'>Delivered At {paidAt}</div>
